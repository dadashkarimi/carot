...
source1 =atlas_list[2]
source2 =atlas_list[3]
source3 =atlas_list[4]
source4 =atlas_list[5]
source5 =atlas_list[6]
source6 =atlas_list[7]
source7 =atlas_list[8]
...
radarchart(as.data.frame.matrix(df_s1),pcol=paletter_vector[1:4], vlcex=1.8,plwd=2,cglwd=1.1,cglcol="black")
mtext(side = 1, line = 1.5, at = 0, cex = 1.5, source1, font = 2)
